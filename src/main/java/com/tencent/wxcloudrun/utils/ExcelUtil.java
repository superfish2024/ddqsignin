...
import com.tencent.wxcloudrun.utils.Excel.Type;
...
public class ExcelUtil<T>
{
    ...
    public List<T> importExcel(String sheetName, InputStream is) throws Exception
    {
        ...
        Sheet sheet = null;
        if (MyStringUtils.isNotEmpty(sheetName))
        {
        ...
        if (rows > 0)
        {
            ...
            for (int i = 0; i < heard.getPhysicalNumberOfCells(); i++)
            {
                ...
                if (MyStringUtils.isNotNull(cell != null))
                {
            ...
            for (int i = 1; i < rows; i++)
            {
                ...
                for (Map.Entry<Integer, Field> entry : fieldsMap.entrySet())
                {
                    ...
                    if (MyStringUtils.isNotNull(fieldType))
                    {
                        Excel attr = field.getAnnotation(Excel.class);
                        ...
                        else if (MyStringUtils.isNotEmpty(attr.readConverterExp()))
                        {
    ...
    public void setCellVo(Object value, Excel attr, Cell cell)
    {
        if (ColumnType.STRING == attr.cellType())
        {
            ...
            cell.setCellValue(MyStringUtils.isNull(value) ? attr.defaultValue() : value + attr.suffix());
        }
    ...
    public void setDataValidation(Excel attr, Row row, int column)
    {
        ...
        // 如果设置了提示信息则鼠标放上去提示.
        if (MyStringUtils.isNotEmpty(attr.prompt()))
        {
            // 这里默认设了2-101列提示.
